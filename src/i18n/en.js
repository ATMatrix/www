export default {
    ...
    solutions: {
        ...
        blockchain: [{
                ...
                content: "We help you determine the ideal type of blockchain solution and how it benefits your business or industry. We employ internal and external subject matter experts (SMEs) whom can work with your team to develop comprehensive use cases and validate their feasibility."
            },
            {
                title: "Tailored Blockchain Solutions",
                content: "Implementation and deployment of latest developments in blockchain technology to diverse industries such as healthcare, finance, manufacturing, logistics, media, legal, education, and many more."
            },
            {
                title: "Third party Blockchain & AI Implementation",
                content: "Filtering through the long list of existing applications to integrate into your current system can be a daunting task. We only work with proven technology providers to ensure backward compatibility and seamless integration with legacy and modern systems."
            }
        ],
        ai: [{
                title: "Cleaning & Monetising Data",
                content: "Smart AI is heavily reliant on good datasets to train and learn. We help you identify new datasets you could be tracking, as well as structure your current datasets to onsell to potential AI applications. New data is automatically shared with our list of trusted vendors."
            },
            {
                title: "AI Consulting & Services",
                content: "There is a never-ending hype in AI. We unscramble the hype and help you with an end-to-end AI strategy and implementation that yields the best results for you. We are experts in AI and work with only the best tools available to ensure the optimal solutions are proposed. Our solutions are always platform agnostic and easy to maintain or support. This provides the right technical foundation for your growth."
            },
            {
                title: "Decentralised Computing Power",
                content: "We also partner with industry leaders in computational services to provide you with the right computing power. We combine these services with independent under-utilised computing power to lower costs and ensure a stable network."
            }
        ]
    },
    benefits: {
        ...
        b: [{
                ...
                content: "By cutting workflow times and intermediaries, your customers can enjoy faster responses and real-time verifications. Automating customer feedback and customer reward programmes ensure a fair and accurate record."
            },
            {
                title: "Optimise your operations",
                content: "By leveraging a decentralised ledger, you can reduce costs associated with third parties, auditors or documentation. Streamlining and automating these processes with AI and blockchain, transactions can be completed faster and more efficiently. "
            },
            {
                title: "Monetize your existing assets",
                content: "By unlocking and tracking your various datasets and digital assets, you can onsell accessibility and automatically get rewarded track everytime they leverage your digital assets. AI models can be trained using your data and re-packaged for enterprise solutions."
            }
        ],
        a: [{
                title: "Enrich your processes with AI",
                content: "Each process is assessed by our team of AI experts for viability. Your applications are also evaluated for compatibility, and a seamless solution is deployed by leveraging our trusted AI vendors. Let us help you take advantage of AI."
            },
            {
                title: "Accelerate your computations",
                content: "Utilize parallel computing to find efficient solutions in seconds not months. Affordable and reliable computing power can be hard to find. Access to the right kind of computational service provider could be crucial in allowing startups to compete with the large budgets."
            }
        ]
    },
    cases: {
    ...
    team: {
        ...
        t: [{
                ...
                name: "Feller Gao",
                position: "CEO",
                des: "Years experiences of strategic planning in IT and CT industry. Was responsible for incubator center. Angel investor of several well known blockchain projects. Master degree of Computer Science from SJTU, major in Artificial Intelligence."
            },
            {
                key: "cto",
                name: "Steven Liu",
            ...
            },
            {
                ...
                des: "Blockchain technology expert, full stack developer. Bitcoin enthusiast, involved in development work of various projects since 2011, specialized in graphene based blockchain technology and EVM based smart contract. Graduated from SJTU, major in Internatonal Trade."
            }
        ],
        a: [{
                key: "meinahong",
                name: "NA. Hong, Mei",
                des: "Academician of the Chinese Academy of Sciences, Academician of the Academy of Sciences in the Developing Countries, IEEE Fellow of the International Society of Electrical and Electronics Engineering, Professor, Famous software expert and scholar, Open Source Software Community advocate."
            },
            {
                key: "zhupp",
                name: "Pin Pin, Zhu",
                des: 'Ranking 8th in the Forbes Leading Technologists in China\'s AI Revolution, ZHU Pinpin owns many patents in the AI industry, including the "Chatting Robot System" and the "SMS Robot System", etc. In addition to running Xiaoi, Zhu has also been appointed to multiple human-machine interaction administration committees, and has received numerous awards and accolades for his contributions to the field.'
            },
            {
                key: "huang",
                name: "Prof. He Yan, Huang",
                des: "Vice President of China Society of Artificial Intelligence, Vice Chairman of China Chinese Information Society, Vice President of China Software Industry Association; Natural Language Processing and Machine Translation experts and scholars, artificial intelligence community advocates."
            },
            {
                key: "ganzx",
                name: "Zhongxue Gan",
                des: "Zhongxue Gan graduated from the University of Connecticut with a Ph.D. in mechanical engineering. He was the director and chief scientist of ABB's Robot Research Center, a Fortune 500 company. He led the technical team to apply more than 200 technical patents."
            },
            {
                key: "guxf",
                name: "Xianfeng Gu",
                des: "Xianfeng Gu won NSF CAREER award, NSFC award for Overseas Outstanding Youth (worked with Professor Hu Shimin), and Fields medal: Morningside Golden Medal of Applied Mathematics. Now he has published over 200 international papers and academic monograph, such as “Computational Conformal Geometry”."
            }
        ]
    },
    contact: {
